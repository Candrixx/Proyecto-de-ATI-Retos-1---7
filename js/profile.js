async function renderizarPerfilEnSPA(cedula) {
    try {
       ...
       const imgFoto = document.querySelector('#foto-perfil');
    ...
    //         // Seleccionamos todas las tarjetas (que ya están en el DOM)
    //         const tarjetas = document.querySelectorAll('.card');
            
    //         tarjetas.forEach(tarjeta => {
    //             // Buscamos el nombre dentro de la tarjeta (ajusta el selector según tu HTML)
    //             const nombre = tarjeta.querySelector('.card-footer p').textContent.toLowerCase();
